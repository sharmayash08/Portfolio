       ...
       <Layout className='pt-0 md:pt-16 sm:pt-8'>
        <div className='flex items-center justify-between w-full lg:flex-col'>
          <div className='w-1/2 md:w-full'>
            <Image src={profilePic} alt="Yash Sharma" className='w-full h-auto lg:hidden md:inline-block md:w-full' 
            priority
          ...
          <div className='w-1/2 flex flex-col item-center self-center lg:w-full lg:text-center'>
            ...
            ' />
            <p className='my-4 text-base font-medium md:text-sm sm:text-sm'>As a skilled full-stack developer, I am dedicated to turning ideas into innovative web applications. 
      Explore my latest projects and articles, showcasing my expertise in React.js and web development.</p>
      <div className='flex items-center self-start mt-2 lg:self-center'>
        <Link href="/YashCV.pdf" target={"_blank"} className="flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark dark:bg-light  dark:text-dark
        ...
        <Link href="mailto:yash280876@gmail.com" target={"_blank"}
