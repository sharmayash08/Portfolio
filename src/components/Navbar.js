    ...
    >
      ...
      <nav>
        ...
        <nav className='flex items-center justify-center flex-wrap'>
            <motion.a href="https://twitter.com/yash280876" target={"_blank"} whileHover = {{y:-5}} whileTap={{scale:0.9}} className="w-6 mr-3"><TwitterIcon /></motion.a>
            ...
            <motion.a href="https://in.pinterest.com/yash280876/" target={"_blank"}whileHover = {{y:-5}} whileTap={{scale:0.9}} className="w-6 mx-3"><PinterestIcon /></motion.a>
            <motion.a href="https://dribbble.com/yash080105" target={"_blank"}whileHover = {{y:-5}} whileTap={{scale:0.9}} className="w-6 mx-3"><DribbbleIcon /></motion.a>
